...
def load_model_api(weights='yolov7.pt', imgsz=640, device='cpu'):
    # Load model
...
if __name__ == '__main__':
    ...
    imgs_path = detect("https://www.thespruce.com/thmb/iMt63n8NGCojUETr6-T8oj-5-ns=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/PAinteriors-7-cafe9c2bd6be4823b9345e591e4f367f.jpg",
                        model=model,
                        stride=stride)
    print(imgs_path)